...
citygml_filepath = os.path.join(parent_path, "pyliburo_example_files", "collada2citygml_example", "citygml", "example2.gml" )
...
for building in buildings:
    ...
    if bcnt == 103:
        pyliburo.py3dmodel.construct.visualise([[solid]], ["WHITE"])
