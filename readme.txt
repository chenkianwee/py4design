...
2.) pip install pyliburo

2.) libraries to download:
    c.) conda install -c https://conda.anaconda.org/dlr-sc pythonocc-core=0.17 (cad kernel for all geometry operations) (GNU LGPL)
    f.) conda install scipy (BSD accepted license)
