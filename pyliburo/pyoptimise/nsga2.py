...
def create_population_class(gene_dict_list, score_dict_list, mutation_rate,crossover_rate,init_population,
    ...
    for gene_dict in gene_dict_list:
        ...
        gene = Gene(gene_type, gene_range)
        gm.add_gene(gene)
    gm.gene_position()
    #====================================
    #score meta
    ...
    for score_dict in score_dict_list:
        ...
        if score_minmax == "min":
            score_m_list.append(ScoreMeta.MIN)
        if score_minmax == "max":
            score_m_list.append(ScoreMeta.MAX)

    sm = ScoreMeta(score_name_list, score_m_list)
    #====================================
    #population class parameters
    #====================================
    
    p = Population(init_population, gm, sm, live_file , dead_file, mutation_rate, crossover_rate)
    return p
