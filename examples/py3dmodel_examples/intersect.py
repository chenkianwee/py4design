...
pypt = (0,0,10)
occ_origcircle = envuo.py3dmodel.construct.make_circle(pypt, (0,0,1),5)
...
#define an edge
dest_pypt = (75,90,10)
occ_edge = envuo.py3dmodel.construct.make_edge(pypt, dest_pypt)
displaylist1.append(occ_edge)
interss = envuo.py3dmodel.calculate.intersect_edge_with_face(occ_edge, occ_face)
if interss:
...
if occ_interpt != None:
    interpt_occcircle = envuo.py3dmodel.construct.make_circle((occ_interpt.X(),occ_interpt.Y(),occ_interpt.Z()), (0,0,1),3)
    displaylist2.append(interpt_occcircle.Edge())
    displaylist2.append(occ_interface)
    interpath = envuo.py3dmodel.construct.make_edge(pypt, (occ_interpt.X(),occ_interpt.Y(),occ_interpt.Z()))
