...
ext1_faces = envuo.py3dmodel.fetch.faces_frm_solid(extrude1)
mext1_faces = []
for ext1_face in ext1_faces:
    srf_dir = envuo.py3dmodel.calculate.face_normal(ext1_face)
    srf_midpt = envuo.py3dmodel.calculate.face_midpt(ext1_face)
    loc_pt = envuo.py3dmodel.modify.move_pt(srf_midpt, srf_dir, 5)
    mext1_face = envuo.py3dmodel.modify.move(srf_midpt, loc_pt, ext1_face)
...
min_dist = envuo.py3dmodel.calculate.minimum_distance(extrude1, extrude2)
