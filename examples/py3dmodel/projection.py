...
face_plane = pylibudo.py3dmodel.construct.make_plane_w_dir((5,5,3), (0,1,0))

pyptlist2 = [(30,30,0), (20,30,0), (20,40,0),(30,40,0)]#clockwise
face2project = pylibudo.py3dmodel.construct.make_polygon(pyptlist2)
projected_facepts = pylibudo.py3dmodel.calculate.project_face_on_faceplane(face_plane, face2project)
face_circles = []
print len(projected_facepts)
for facept in projected_facepts:    
    pyfacept = (facept.X(),facept.Y(),facept.Z())
    projpt_facecircle = pylibudo.py3dmodel.construct.make_circle(pyfacept, (0,0,1),5)
...
projected_pt = pylibudo.py3dmodel.calculate.project_point_on_faceplane(occ_face, pypt)
pyprojpt = (projected_pt.X(), projected_pt.Y(),projected_pt.Z())
projpt_occcircle = pylibudo.py3dmodel.construct.make_circle(pyprojpt, (0,0,1),5)
#create the edge between the origpt and the projpt
projpt_occedge = pylibudo.py3dmodel.construct.make_edge(pypt, pyprojpt)
...
dest_occedge = pylibudo.py3dmodel.construct.make_edge((50,100,0), (50,20,0))
interedgept =pylibudo.py3dmodel.calculate.project_point_on_infedge(dest_occedge, pypt)
interedgept_occcircle = pylibudo.py3dmodel.construct.make_circle((interedgept.X(), interedgept.Y(), interedgept.Z()), (0,0,1),3)
interedgept_path = pylibudo.py3dmodel.construct.make_edge(pypt, (interedgept.X(), interedgept.Y(), interedgept.Z()))
